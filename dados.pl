...
ligacao(filadelfia, new_jersey, 150).     % ligação menos distante
ligacao(filadelfia, washington, 220).
ligacao(washington, new_jersey, 300).
ligacao(cincinnati, seattle, 3700).       
ligacao(seattle, pasadena, 1800).
ligacao(pasadena, new_jersey, 4300).      % ligação mais distante

% Cidade inicial e cidade final para o seguinte trajeto
